...
const Projects = () => {
  return (
    <div className="d-flex justify-content-center h-75 gap-2 flex-wrap">
      <div id={styles.cardProject} className="d-flex justify-content-center align-content-stretch my-auto flex-wrap gap-4 mt-5">
